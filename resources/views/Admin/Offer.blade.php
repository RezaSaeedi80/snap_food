                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div
                        ...
                        <div class="flex gap-3 items-center mb-4">
                            <h5 class="pl-3 text-xl font-bold leading-none text-gray-900 dark:text-white">Offers</h5>
                            <div class="pt-1">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="mb-6">
                                            <input type="text" name="persent"
                                                class="hover:shadow-xl hover:shadow-zinc-900/70 form-control mb-3 block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                                id="persent" placeholder="Persent">
                                            <p class="text-red-500 text-xs italic hidden" id="persent_error"></p>
                                        </div>
                                        <button type="submit" onclick="Offer(this)"
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="mb-6">
                                                            <input type="text" name="persent"
                                                                ...
                                                                placeholder="Persent">
                                                            <p class="text-red-500 text-xs italic hidden"
                                                                id="persent_error{{ $item->id }}"></p>
                                                        </div>
                                                        <button type="button" onclick="OfferEdit(this)"
                                                            value="{{ $item->id }}"
                                                            class="hover:shadow-zinc-900/70 w-full px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-xl hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">add</button>
                                                    </div>
                                                </div>
                                            ...
                                            <div id="{{ $item->id }}delete" class="modal w-[300px]">
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex space-x-2 justify-center">
                                                        <button type="button" onclick="deleteOffer(this)"
                                                            value="{{ $item->id }}"
    ...
    Offer = function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response['error']['persent'] != null) {
                    $('#persent_error').text(response['error']['persent']);
                    $('#persent_error').removeClass('hidden');
                } else {
                    $('#persent_error').addClass('hidden');
                }
    ...
    OfferEdit = function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response['error']['persent'] != null) {
                    $('#persent_error' + e.value).text(response['error']['persent']);
                    $('#persent_error' + e.value).removeClass('hidden');
                } else {
                    $('#persent_error' + e.value).addClass('hidden');
                }
