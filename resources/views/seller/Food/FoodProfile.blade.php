...
@section('main')
    <div class="relative w-[700px] h-[500px] mx-auto mt-[12vh] bg-white rounded-lg">
        <div class="absolute top-[-60px] left-[-60px] w-fit rounded-full">
            <img src="{{ asset('images/defult2.jpg') }}" alt="" class="w-[180px] rounded-full">
            <button id="open-file"
        ...
        <form class="w-[400px] mx-auto pt-[10vh]" method="POST" action="{{ route('food.update', $food) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
