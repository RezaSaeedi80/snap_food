            ...
            <div class="w-[900px] mx-auto bg-white rounded-lg p-3 overflow-auto">
                <div class="flow-root h-[600px]">
                    ...
                    <div class="flex gap-4">
                        <div class="mb-4">
                            ...
                            <div id="dropdownAction"
                                ...
                                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                    ...
                                    <li>
                                        <form class="w-full" action="{{ route('payment.index', $resturant) }}"
                                            method="get">
                        ...
                        <form action="{{ route('save.order', $resturant) }}">
                            <button
                                type="submit"
                                class="inline-flex items-center text-gray-500 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-3 py-1.5 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">Save to excel</button>
                        </form>
                    </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($orders as $order)
                                    <tr
                                        ...
                                        <td class="text-center py-4 px-6">
                                            <a href="{{ route('payment.show', [$resturant, $order]) }}"
